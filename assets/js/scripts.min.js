...
!function (c) {
  c.fn.simpleJekyllSearch = function (e) {
    var l = c.extend({
      ...
      jsonFormat: "title,keywords,lecturersStr,acronym,descriptionSl",
      template: '<li><article><a href="{url}">{title} <span class="entry-author">{lecturersStr}</span><span class="entry-keywords">{keywords}</span></a></article></li>',
