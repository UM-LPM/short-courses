...
!function (c) {
    c.fn.simpleJekyllSearch = function (e) {
        var l = c.extend({
            ...
            jsonFormat: "title,keywords,lecturersStr,acronym,descriptionSl,acronym",
            template: '<li><article><a href="/{acronym}">{title} <span class="entry-author">{lecturersStr}</span><span class="entry-keywords">{keywords}</span></a></article></li>',
...
!function (e, t) {
    ...
    function createCourseElement(course) {
        ...
        const authors = course.lecturersStr ?? "";
