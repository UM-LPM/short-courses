...
!function (c) {
    c.fn.simpleJekyllSearch = function (e) {
        var l = c.extend({
            ...
            jsonFormat: "title,keywords,lecturersStrSl,acronym,descriptionSl,acronym",
            template: '<li><article><a href="/{acronym}">{title} <span class="entry-author">{lecturersStrSl}</span><span class="entry-keywords">{keywords}</span></a></article></li>',
