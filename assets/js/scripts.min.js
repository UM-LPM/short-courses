!function(){for(var t=document.querySelectorAll(".course-content h1[id],.course-content h2[id],.course-content h3[id],.course-content h4[id],.course-content h5[id],.course-content h6[id]"),e=0;e<t.length;e++){var i=document.createElement("img"),r=(i.setAttribute("src","/assets/img/link-symbol.svg"),i.setAttribute("alt",""),document.createElement("a"));r.setAttribute("href","#"+t[e].getAttribute("id")),r.setAttribute("aria-hidden","true"),r.setAttribute("tabindex","-1"),r.classList.add("anchor"),r.appendChild(i),t[e].insertBefore(r,t[e].firstChild)}}();
...
!function(e,t){"function"==typeof define&&define.amd?define([],function(){return t()}):"object"==typeof exports?module.exports=t():e.courseDisplay=t()}("undefined"!=typeof global?global:this.window||this.global,function(e){"use strict";function t(){fetch("course-data.json").then(e=>e.json()).then(e=>{e=e.filter(e=>{var t=new Date,n=e.publishDate?new Date(e.publishDate):null,e=e.removalDate?new Date(e.removalDate):null;return!(!n||t<n)&&!(e&&e<=t)});let t=[],n=[];const a=new Date;e.forEach(e=>{(e.unparsedExecutionStartDate&&new Date(e.unparsedExecutionStartDate)>=a?(e.executionStartDate=r(e.unparsedExecutionStartDate),e.executionEndDate=r(e.unparsedExecutionEndDate),t):n).push(e)}),t.sort((e,t)=>new Date(e.unparsedExecutionStartDate)-new Date(t.unparsedExecutionStartDate));e=function(){let e=localStorage.getItem("courseShuffleSeed");e||(e=Math.floor(1e6*Math.random()),localStorage.setItem("courseShuffleSeed",e));return parseInt(e,10)}(),e=function(e,t){let n=e.length,a,o;for(;n;)o=Math.floor(function(e){e=1e4*Math.sin(e);return e-Math.floor(e)}(t)*n--),a=e[n],e[n]=e[o],e[o]=a,++t;return e}(n,e),e=[...t,...e];const o=document.getElementById("grid");o.innerHTML="",e.forEach(e=>{e=function(e){const t=document.createElement("article"),n=(t.style.opacity=1,t.className="box-item",e.keywords?e.keywords.split(", ").map(e=>e.trim()):[]),a=e.keywordsEn?e.keywordsEn.split(", ").map(e=>e.trim()):[],o=e.title??"",r=e.titleEn||o,s=e.lecturersStrSl??"",i=e.lecturersStrEn||s,c=e.descriptionSl??"",l=e.descriptionEn||c,u=e.executionStartDate,d=e.executionEndDate,p=(e,t)=>e===t?e:`<span data-sl>${e}</span><span data-en>${t}</span>`,f=u&&d?u+" - "+d:"",h=e.image?`${e.image}/512/${e.acronym}.png`:"/assets/img/placeholder.png",g=n.map((e,t)=>`<a href="/tags/#${e.toLowerCase().replace(/ /g,"-")}" class="tag">${p("#"+e,"#"+(a[t]||e))}</a>`).join(" "),m=o.replace(/"/g,"&quot;"),D=f?`<h3 class="course-dates" style="margin-top:0;">${f}</h3>`:"",w=s?`<h3 class="course-author" style="margin-top:0;">${p(s,i)}</h3>`:"";return t.innerHTML=`
    <span class="category"><span>${p(o,r)}</span></span>
    <div class="box-body">
      <a class="cover" href="${e.url}">
        <img src="${h}" alt="${m}" width="100%" class="preload">
        <noscript><img src="/assets/img/off.jpg" alt="${m}" width="100%"></noscript>
        <div class="read-icon">
      ...
      <div class="box-info">
        <a class="course-link" href="${e.url}">
          ${D}
          ${w}
          <p class="description">${p(y(c),y(l))}</p>
        </a>

        <div class="tags">${g}</div>
      </div>
    </div>
  `,t}(e);o.appendChild(e)})}).catch(e=>console.error("Error loading course data:",e))}function r(e){return e?new Date(e).toLocaleString([],{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}):null}function y(e){var t;return e?20<(t=e.split(" ")).length?t.slice(0,20).join(" ")+"...":e:""}return{init:function(){document.addEventListener("DOMContentLoaded",t)}}}),"/"!==window.location.pathname&&"/home.html"!==window.location.pathname||"undefined"==typeof courseDisplay||courseDisplay.init();
function setLangCookie(e){var a=new Date(Date.now()+31536e6).toUTCString();document.cookie="pll_language="+e+"; expires="+a+"; path=/; SameSite=Lax"}function updatePlaceholders(a){document.querySelectorAll("[data-placeholder-sl]").forEach(function(e){e.placeholder="en"===a&&e.getAttribute("data-placeholder-en")||e.getAttribute("data-placeholder-sl")})}function toggleLang(){var e=document.documentElement,a=e.classList.contains("lang-en")?"sl":"en";e.classList.remove("lang-sl","lang-en"),e.classList.add("lang-"+a),localStorage.setItem("lang",a),setLangCookie(a),updatePlaceholders(a)}var _initLang=localStorage.getItem("lang")||"sl";setLangCookie(_initLang),updatePlaceholders(_initLang);
...
!function(i){i.fn.simpleJekyllSearch=function(e){var n=i.extend({jsonFile:"/search.json",jsonFormat:"title,keywords,author,url",template:'<li><article><a href="{url}">{title}<span class="entry-author">{author}</span><span class="entry-keywords">{keywords}</span></a></article></li>',searchResults:".search-results",limit:"10",noResults:"<p>Žal, nismo našli rezultate :(</p>"},e),l=n.jsonFormat.split(","),o=[],t=this,a=i(n.searchResults);function r(){a.children().remove()}n.jsonFile.length&&a.length&&i.ajax({type:"GET",url:n.jsonFile,dataType:"json",success:function(e){o=e,t.keyup(function(){var e,t,s;i(this).val().length?(t=i(this).val(),s=[],i.each(o,function(e,n){-1!==(n.title+" "+n.author+" "+n.keywords).toLowerCase().indexOf(t.toLowerCase())&&s.push(n)}),e=s,r(),e.length?i.each(e,function(e,t){var s;e<n.limit&&(s=n.template,i.each(l,function(e,n){s=s.replace(new RegExp("{"+n+"}","g"),t[n])}),a.append(i(s)))}):a.append(n.noResults)):r()})},error:function(e,n,t){console.log("***ERROR in simpleJekyllSearch.js***"),console.log(e),console.log(n),console.log(t)}})}}("undefined"!=typeof jQuery?jQuery:Zepto);
...
function addLoader(e){e.addClass("ajaxLoading"),setTimeout(function(){e.addClass("ajaxLoading--isLoading")},5)}function removeLoader(e){e.removeClass("ajaxLoading--isLoading"),setTimeout(function(){e.removeClass("ajaxLoading")},150)}function alterHTML(){var e=$(".wp-block-group"),e=(e.length&&e.each(function(){var e=$(this);e.wrapInner('<div class="row"></div>'),e.removeClass("wp-block-group")}),$("h1")),e=(e.length&&e.each(function(){var e=$(this);e.closest(".title").length||e.hasClass("default")||e.wrap('<div class="title"></div>')}),$(".sideNav")),e=(!e.length||(t=$(".section--bc")).length&&!t.find(".cNav").length&&(t.find(".row").prepend('<nav data-mobile class="cNav">'+e.html()+"</nav>"),t.find(".row").prepend('<div data-mobile><div class="cNavTrigger text--right"><button class="button button--reset pa-4 pr-3 button--sm cNavToggle"><strong>MENI</strong><i class="icon-menu ml-4"></i></button></div></div>'),t.find(".cNav ul").removeClass("ul--bb")),$(".sideNav.sideNav--sub")),t=(e.length&&(e.find("li").each(function(){var e=$(this);e.hasClass("page_item_has_children")&&(0<e.find(">ul.children>li").length&&e.find("> a").append('<button class="subNavToggle" aria-expanded="false"></button>'),(e.hasClass("current_page_item")||e.hasClass("current_page_parent")||e.hasClass("current_page_ancestor"))&&e.addClass("is--active").find(">a>button").attr("aria-expanded","true")),e.hasClass("current_page_item")&&e.closest(".page_item_has_children").addClass("is--active").find(">a>button").attr("aria-expanded","true")}),$(".subNavToggle").on("click",function(){return $(this).closest("li").toggleClass("is--active"),$(this).closest(".stickyContainer").length&&$(".stickyContainer").sticky("update"),!1})),$(".cNav"));function n(){}t.length&&t.each(function(){var e=$(this),t=e.find("li.page_item_has_children");e.find("li.page_item_has_children > a").append('<button class="subMenuToggle" aria-expanded="false"></button>'),t.each(function(){var e=$(this);e.find("> ul.children > li").length||e.find("> ul.children").remove(),e.find(">button").length&&!e.find(">button + ul.children").length&&n($(this).find(">button")),e.find(">ul").length&&e.find(">ul button").each(function(){n($(this))})}),e.closest(".section--bc")&&e.attr("data-count",e.find("> ul > li").length)});$("#wpadminbar").length&&$("body").addClass("wp-admin-toolbar");e=$("table");e.length&&e.each(function(){$(this).addClass("wp-block-table is-style-stripes")})}function ajaxGetPost(t,n){var e=$.ajax({type:"POST",url:themeOBJ.ajax_url,data:t,dataType:"json"});n.addClass("is--loading"),e.done(function(e){e=e.data;n.html(e.html),$(".loadMoreButton").on("click",function(){t.paged=t.paged+1,ajaxGetPost(t,n)}),n.removeClass("is--loading"),$("#postNumOfResults").text(e.num_posts)}),e.fail(function(e,t){console.log("Request failed: "+t)})}function numberCounter(e){var t=e.attr("data-number-counter");0<t&&$({Counter:0}).animate({Counter:t},{duration:2e3,easing:"swing",step:function(){e.text(Math.ceil(this.Counter))},start:function(){e.attr("data-number-counter",0)},complete:function(){e.attr("data-number-counter",0)}})}function ajaxGetDocuments(e,t){e=$.ajax({type:"POST",url:themeOBJ.ajax_url,data:e,dataType:"json"});t.addClass("is--loading"),e.done(function(e){e=e.data,t.html("<div>"+e.html+"</div>"),t.removeClass("is--loading"),$("#postNumOfResults").text(e.num_posts),e=$(".fileBlockAccordion__trigger");e.length&&e.on("click",function(){var e=$(this).closest(".fileBlockAccordion");e.hasClass("is--active")?e.removeClass("is--active"):($(".fileBlockAccordion.is--active").removeClass("is--active"),e.addClass("is--active"))})}),e.fail(function(e,t){console.log("Request failed: "+t)})}function filter_category(t,n){var e=$('select[name="filter_category"]'),a=t.data("query");e.on("change",function(){var e=parseInt($(this).val());a.cat=e,ajaxGetPost(a,n),t.attr("data-query",JSON.stringify(a))})}function filter_search(t,n){var a=$('input[name="filter_searchTerm"]'),e=$("#postSearchForm"),o=t.data("query");a.on("keyup",function(e){$(this).val()||(o.s=null,ajaxGetPost(o,n),t.attr("data-query",JSON.stringify(o)))}),e.on("submit",function(){var e=a.val();return 0<e.length&&(o.s=e,ajaxGetPost(o,n),t.attr("data-query",JSON.stringify(o))),!1})}function filter_search_all(t,n){var a=$('input[name="input_search"]'),o=a.closest("form"),i=t.data("query");o.on("submit",function(){var e=sanitizeInput(a.val());return i.cpt=o.find('input[name="cpt"]:checked').val(),i.s=e,ajaxGetPost(i,n),t.attr("data-query",JSON.stringify(i)),!1})}function sanitizeInput(e){return e=e.replace(/</g,"&lt;").replace(/>/g,"&gt;")}function filter_file_category(t,n){var e=$('select[name="filter_category"]'),a=t.data("query");e.on("change",function(){var e=parseInt($(this).val());a.cat=e,ajaxGetDocuments(a,n),t.attr("data-query",JSON.stringify(a))})}function filter_file_search(t,n){var a=$('input[name="filter_searchTerm"]'),e=$("#postSearchForm"),o=t.data("query");a.on("keyup",function(e){$(this).val()||(o.s=null,ajaxGetDocuments(o,n),t.attr("data-query",JSON.stringify(o)))}),e.on("submit",function(){var e=a.val();return 0<e.length&&(o.s=e,ajaxGetDocuments(o,n),t.attr("data-query",JSON.stringify(o))),!1})}function close_search(){toggle_aria_expanded($(".searchToggle"),!1),toggle_aria_hidden($(".header__search"),!0),$(".header").removeClass("header--searchVisible")}function close_ribbon_nav(){$('.cNav button[aria-expanded="true"]').attr("aria-expanded","false"),$('.cNav ul[aria-hidden="false"]').attr("aria-hidden","true")}function close_dropdown(){toggle_aria_expanded($(".dropdown__trigger .button[aria-expanded]"),!1),$(".dropdown--active").removeClass("dropdown--active"),$(".dropdown--active-parent").removeClass("dropdown--active-parent")}function close_mega_menus(){toggle_aria_expanded($(".mainNav > ul > li > button[aria-expanded]"),!1),toggle_aria_hidden($(".mainNav__subMenu"),!0)}function toggle_aria_expanded(e,t){$(e).attr("aria-expanded",t?"true":"false")}function toggle_aria_hidden(e,t){$(e).attr("aria-hidden",t?"true":"false")}function get_first_focusable_element(e){if(e)return e.find('a, button, input, select, textarea, [tabindex]:not([tabindex="-1"])').filter(":visible").not(":disabled").first()||e}$(window).on("load",function(){}),$(document).ready(function(){$(".cNav").find("ul.children li").length||$(".cNav").find("ul.children").remove();var e=$(".page");setTimeout(function(){e.removeClass("page--loading"),setTimeout(function(){e.find(".page__loader").remove(),$("#popup").addClass("show")},250)},250)}),$(function(){$(document.body).on("click",".cNavToggle",function(){$(".cNav").toggleClass("cNav--visible"),$(this).toggleClass("cNavToggle--active")});var e,t=$("#postQueryInput"),n=(t.length&&(e=$("#ajaxResult"),ajaxGetPost(t.data("query"),e),filter_category(t,e),filter_search(t,e)),$("[data-number-counter]"));$(window).on("load resize scroll",function(){n.length&&n.each(function(){$(this).isInViewport()&&numberCounter($(this))})}),$("body").on("click","[data-popup-close]",function(){return $(this).closest(".popupContainer").removeClass("popupContainer--visible"),setTimeout(function(){$(this).closest(".popupContainer").remove()},600),!1})}),$.fn.isInViewport=function(){var e=$(this).offset().top,t=e+$(this).outerHeight(),n=$(window).scrollTop(),a=n+$(window).height();return n<t&&e<a},$(function(){let t=$(".header"),n=$("body"),a=($(".dropdown__trigger > button[aria-expanded]").on("click",function(e){e.preventDefault();var e=$(this),t=e.closest(".dropdown"),n=t.hasClass("dropdown--hmiDesktop"),a=e.closest(".dropdownWrapper"),o=(t.find(".dropdown__content"),"true"===e.attr("aria-expanded"));t.toggleClass("dropdown--active"),a.toggleClass("dropdown--active-parent"),n&&((t=e.closest(".dropdown").find(".dropdown__content .dropdown__trigger button[aria-expanded]")).focus(),toggle_aria_expanded(t,!o)),toggle_aria_expanded(e,!o)}),$(".mainNav > ul > li > button[aria-expanded]").on("click",function(e){e.preventDefault();var e=$(this),t=e.parent().find(".mainNav__subMenu"),n="true"===e.attr("aria-expanded");n||close_mega_menus(),toggle_aria_expanded(e,!n),toggle_aria_hidden(t,n)}),$(".navToggle").on("click",function(e){e.preventDefault(),toggle_aria_expanded($(this),!t.hasClass("header--navVisible")),t.toggleClass("header--navVisible"),n.toggleClass("overflow--hidden")}),$(".cNav button[aria-expanded], .sideNav button[aria-expanded]").on("click",function(e){e.preventDefault();var e=$(this),t=e.parent().find("> ul.children"),n="true"===e.attr("aria-expanded");toggle_aria_expanded(e,!n),toggle_aria_hidden(t,n)}),$("#open_sogoacc")),e=$("#sogoacc"),o=(a.length&&e.length&&$(".triggerAccessibilityControls").on("click",function(e){e.preventDefault(),a.trigger("click")}),$(".skip-to-content-btn").on("click",function(e){e.preventDefault(),get_first_focusable_element($("main")).focus()}),$(".skip-section-btn").on("click",function(e){e.preventDefault(),get_first_focusable_element($(this).closest("section").nextAll()).focus()}),$(".searchToggle").on("click keydown",function(e){if(("keydown"!==e.type||9!==e.keyCode)&&(e.preventDefault(),"keydown"!==e.type||32===e.keyCode||13===e.keyCode)){let e=$(this),t=$(".header__search"),n="true"===e.attr("aria-expanded");$(".header").toggleClass("header--searchVisible"),n||(e.addClass("is-clicked"),t.find("input:not(:checked)").first().focus(),setTimeout(()=>{e.removeClass("is-clicked")},50)),toggle_aria_expanded(e,!n),toggle_aria_hidden(t,n)}}),$(document).on("focusout",".dropdown__content",function(e){var t=$(this);t.is(":focus-within")||t.find(".dropdown__trigger > button[aria-expanded]").focus(),setTimeout(()=>{$(".dropdown").has(document.activeElement).length||$(".dropdown--active .dropdown__trigger .button").focus()},0)}),$(document).on("focusout",".mainNav__subMenu",function(e){$(this).is(":focus-within")||$(this).parent().find("button[aria-expanded]").focus()}),$(document).on("focusout",".searchToggle:not(.is-clicked)",function(e){console.log(e),!$(this).is(":focus-within")&&$(".header--searchVisible").length&&$(".header__search").find("input:not(:checked)").first().focus()}),$(document).on("focusout",".header__search",function(e){$(this).is(":focus-within")||$(".searchToggle").focus()}),$(document).on("focusout","#sogoacc",function(e){$(this).is(":focus-within")||$("#sogoacc").hide()}),$(document).on("focusout",".header__mobileNav",function(e){$(this).is(":focus-within")||$(".navToggle").focus()}),$(document).on("focusout",".popup",function(e){$(this).is(":focus-within")||get_first_focusable_element($(this)).focus()}),$(document).on("focusout",".cDiagramPopup.is-visible",function(e){$(this).is(":focus-within")||get_first_focusable_element($(this)).focus()}),$(document).on("focusout",".cNav",function(e){$(this).is(":focus-within")||close_ribbon_nav()}),$(document).on("keydown",".search-form",function(e){13!==e.keyCode||$(e.target).is("input[type='search'], button")||e.preventDefault()}),null);$(".cSlider").on("focusout",function(){$(this).is(":focus-within")||(o=null)}),$(document).on("focusin",".ctB ",function(){$(this).data("isFocused",!0)}).on("focusout",".ctB ",function(){$(this).removeClass("focused-click").removeData("isFocused")}).on("click",".ctB ",function(){$(this).data("isFocused")&&$(this).addClass("focused-click")}),$(document).on("focusout",".ctB.focused-click",function(e){var t=$(this);t.is(":focus-within")||(t.closest(".cSlider").find(".owl-item.active a:first").focus(),o=t)}),$(document).on("focusout",".cSlider .buttonContainer",function(e){var t=$(this),n=t.closest(".cSlider");o&&!t.is(":focus-within")&&(o&&o.length?o.next().length?o.next().focus():((t.closest("section").nextAll().length?t.closest("section").nextAll().find('a, button, input, select, textarea, [tabindex]:not([tabindex="-1"])').filter(":visible").first():$(".footer").find("a:first")).focus(),n.trigger("focusout")):n.find(".ctB.is--active").length&&!n.find(".ctB.is--active").is(":last-child")&&n.find(".ctB.is--active").next().focus(),o=null)}),$(document).on("click",function(e){e=$(e.target);e.closest(".mainNav").length||close_mega_menus(),e.closest(".dropdown").length||close_dropdown(),e.closest(".cNav").length||close_ribbon_nav(),e.closest(".header__search, .searchToggle").length||close_search()}),$(document).on("keydown",function(e){"Escape"!==e.key&&27!==e.keyCode||($("#popupContainer").html(""),close_ribbon_nav(),close_dropdown(),close_mega_menus(),close_search(),cDiagramClosePopup())})});
