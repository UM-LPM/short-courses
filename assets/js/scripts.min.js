...
!function(e, t) {
    ...
    function createCourseElement(course) {
        ...
        const authors = course.lecturersString;
        ...
        article.innerHTML = `
          <span class="category"><span>${course.titleSl}</span></span>
          <div class="box-body">
            ...
            <div class="box-info">
              <a class="course-link" href="${course.url}">
                ...
                <h3 class="course-title"">${course.field}</h3>
                <p class="description">${shortenDescription(course.descriptionSl)}</p>
              </a>
