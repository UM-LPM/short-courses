...
!function(c){
    c.fn.simpleJekyllSearch=function(e){
        ...
        function renormalizeText(text) {
            return text.replace(/s/g, "š").replace(/c/g, "č").replace(/z/g, "ž")
                       .replace(/S/g, "Š").replace(/C/g, "Č").replace(/Z/g, "Ž");
        }
        ...
        l.jsonFile.length&&i.length&&c.ajax({
            ...
            success:function(e,t,n){
                o=e,s.keyup(function(e){
                    var t,n,s;
                    c(this).val().length?(n=normalizeText(c(this).val()),s=[],
                    c.each(o,function(e,t){
                        for(e=0;e<a.length;e++)void 0!==t[a[e]]&&-1!==normalizeText(t[a[e]].toLowerCase()).indexOf(n.toLowerCase())&&(s.push(t),e=a.length)
                        ...
                        if(e<l.limit){
                            for(var n=l.template,e=0;e<a.length;e++){
                                ...
                                var fieldValue = t[a[e]] ? renormalizeText(t[a[e]]) : "";
                                n=n.replace(s, fieldValue);
                            }
                            i.append(c(n))
                        }
