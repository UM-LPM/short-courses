...
!function(e, t) {
    ...
    function createCourseElement(course) {
        ...
        article.innerHTML = `
          <span class="category"><span>${fields}</span></span>
          <div class="box-body" style="color: red;">
            ...
            <div class="box-info">
              <a class="course-link" href="${course.url}">
                <h3 class="course-author" style="color:rgb(118, 115, 115); margin-top:0;">${authors}</h3>
  ...
  !function() {
    "undefined" != typeof courseDisplay && courseDisplay.init();
  }();  
